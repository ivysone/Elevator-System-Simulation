...
class ElevatorGUI:
    ...
    def create_elevator_canvas(self):
        """Compute canvas size dynamically so all floors fit on the screen."""
        screen_height = self.root.winfo_screenheight()
        margin = 250  # Adjust margin to account for controls and window decorations
...
def main():
    ...
    file_entry.insert(0, "customers.txt")

...
class Elevator:
    ...
    def move(self, customers):
        ...
        # SCAN algorithm movement: move one floor in current direction
        if self.direct == "up":
    ...
    def register_customer(self, customer):
        ...
        customer.boarding_time = current_time  # Set boarding time
    ...
    def cancel_customer(self, customer):
        ...
        customer.fin = 1
        customer.exit_time = current_time  # Set exit time
...
class Customer:
    def __init__(self, ID, on_floor, going_floor, num_of_floors):  # Changed to accept file data
        global current_time
        
        self.ident = ID
        self.indicator = 0
        self.fin = 0
        self.on_floor = on_floor        # From file data
        self.going_floor = going_floor  # From file data
...
def calculate_efficiency(customers, elevator):
    ...
    for customer in customers:
        if customer.fin:  # Only consider delivered customers
...
try:
    ...
    file_path = os.path.join(script_dir, 'customers.txt')  # Fixed filename
    ...
    # Calculate number of floors from data
...
# Create customers from file data
customers = []
